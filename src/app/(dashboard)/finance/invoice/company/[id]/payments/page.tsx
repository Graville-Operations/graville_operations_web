...
import { useCompanyPaymentHistory } from '@/hooks/company-invoices/useCompanyPaymentHistory';
...
export default function CompanyInvoicePaymentHistoryPage() {
  const { id } = useParams<{ id: string }>();
  const router = useRouter();
  const { history, loading, error } = useCompanyPaymentHistory(id);
