...
import { useSupplierPaymentHistory } from '@/hooks/supplier-invoices/useSupplierPaymentHistory';
...
export default function SupplierInvoicePaymentHistoryPage() {
  const { id } = useParams<{ id: string }>();
  const router = useRouter();
  const { history, loading, error } = useSupplierPaymentHistory(id);
