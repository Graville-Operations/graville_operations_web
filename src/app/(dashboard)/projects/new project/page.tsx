...
// Shared Tailwind class for all native inputs / selects / textareas
const inputCls =
...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/dashboard/projects/dashboard");
    } catch (err: unknown) {
      setError(
  ...
  return (
    <div className="max-w-2xl mx-auto pb-16">
      ...
      {/* back link */}
      <Link
        href="/dashboard/projects/dashboard"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          <Link href="/dashboard/projects/dashboard">
