...
import { VehicleRepairStatus, REPAIR_STATUS_META } from '@/types/vehicle-repair';

const STATUS_OPTIONS = Object.values(VehicleRepairStatus).map((value) => ({
  value,
  label: REPAIR_STATUS_META[value].label,
}));

interface RepairStatusFilterDropdownProps {
  value: VehicleRepairStatus | null;
  onChange: (status: VehicleRepairStatus | null) => void;
}

export default function RepairStatusFilterDropdown({ value, onChange }: RepairStatusFilterDropdownProps) {
